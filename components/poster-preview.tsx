...
export function PosterPreview({ spec, zoom = 1 }: Props) {
  ...
  return (
    <div className="mx-auto w-full">
      <div className="mx-auto aspect-[216/303] w-full max-w-[min(100%,520px)] overflow-hidden rounded-xl border border-stone-300/90 bg-white p-3 shadow-[0_10px_30px_rgba(0,0,0,0.08)] sm:p-4">
